...
onMounted(() => {
    ...
    // treeChart.value.on('contextmenu', conextM)
    // window.addEventListener('resize', () => {
    //     treeChart.value?.resize()
    // })
    //treeChart.value.bind("contextmenu", function () { return false; });
})
...
//     () => {
//         console.log(444444)
//         console.log(treeChart.value)
//         option.series[0].data = [treeData.value]
//         //treeChart.value.setOption(option)
//     }
// )

const conextM = computed((e: any) => {

    // console.log(props.treeData.name)
    // treeChart.value.option.series[0].data = props.treeData
    // treeChart.value.setOption(option)
})
...
function onClick(e: any) {
    ...
    if (e.event.target.culling == true) {
        ...
        console.log(e.data, e.event.target.culling, option)
        e.data.name = '333'
        option.series[0].data = e.data
