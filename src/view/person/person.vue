          ...
          <div class="user-card px-6 text-center bg-white shrink-0">
            ...
            <div class="w-full h-full text-left">
              <ul class="inline-block h-full w-full">
                ...
                <el-tooltip class="item" effect="light" content="北京安新科技公司" placement="top">
                  <li class="info-list">
                    <el-icon>
                      <data-analysis />
                    </el-icon>
                ...
                <el-tooltip class="item" effect="light" content=" GoLang/JavaScript/Vue/PHP/c/c++/java/react"
                  placement="top">
                  <li class="info-list">
                    <el-icon>
                      <medal />
                    </el-icon>
                    GoLang/JavaScript/Vue/PHP/c/c++/java/react
                  </li>
                </el-tooltip>
              </ul>
            </div>
