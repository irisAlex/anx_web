        ...
        <el-collapse-item name="1">
          ...
          <el-form ref="getTableForm" style="margin-top:24px" :inline="true" :model="dbform" label-width="120px">
            <el-form-item label="业务库" prop="selectDBtype">
              ...
              <el-select v-model="dbform.businessDB" clearable class="w-56" placeholder="选择业务库" @change="getDbFunc">
            ...
            <el-form-item label="数据库名" prop="structName">
              <el-select v-model="dbform.dbName" clearable class="w-56" filterable placeholder="请选择数据库"
                @change="getTableFunc">
            ...
            <el-form-item label="表名" prop="structName">
              <el-select v-model="dbform.tableName" :disabled="!dbform.dbName" class="w-56" filterable
                placeholder="请选择表">
    ...
    <div class="gva-search-box">
      ...
      <el-form ref="autoCodeForm" :rules="rules" :model="form" label-width="120px" :inline="true">
        ...
        <el-form-item prop="abbreviation">
          <template #label>
            <el-tooltip content="简称会作为入参对象名和路由group" placement="bottom" effect="light">
              <div> Struct简称 <el-icon>
                  <QuestionFilled />
                </el-icon> </div>
            </el-tooltip>
          </template>
        ...
        <el-form-item prop="packageName">
          <template #label>
            <el-tooltip content="生成文件的默认名称(建议为驼峰格式,首字母小写,如sysXxxXxxx)" placement="bottom" effect="light">
              <div> 文件名称 <el-icon>
                  <QuestionFilled />
                </el-icon> </div>
            </el-tooltip>
          </template>
          <el-input v-model="form.packageName" placeholder="请输入文件名称" @blur="toLowerCaseFunc(form, 'packageName')" />
        </el-form-item>
        ...
        <el-form-item label="业务库" prop="businessDB">
          ...
          <el-select v-model="form.businessDB" class="w-56" placeholder="选择业务库">
            <el-option v-for="item in dbList" :key="item.aliasName" :value="item.aliasName" :label="item.aliasName"
              :disabled="item.disable">
              <div>
                <span>{{ item.aliasName }}</span>
        ...
        <el-form-item>
          <template #label>
            <el-tooltip content="注：会自动在结构体global.Model其中包含主键和软删除相关操作配置" placement="bottom" effect="light">
              <div> 使用GVA结构 <el-icon>
                  <QuestionFilled />
                </el-icon> </div>
            </el-tooltip>
